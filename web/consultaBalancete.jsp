...
<html style="background-color:rgba(0, 0, 242, 0.1)">
    ...
    <body>
            ...
            <div class="container3">
                ...
                <div>
                    ...
                    <div class="container-item">
                        ...
                        <p  class="ret13">Total Gastos: <span><%out.write(ConversorData.formataMoeda(valorDespesa));%> </span></p>
        ...
        <script>
            ...
            if (valor < 0) {
                saldo.style = "color:red;font-weight:bold";
            } else {
                saldo.style = "color:blue;font-weight:bold";
            }
