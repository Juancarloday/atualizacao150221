...
<html style="background-color:rgba(0, 0, 242, 0.1)">
                ...
                <h3>
                    ...
                    <div class="cadcat"><h1>Cadastro Receita</h1>
                        <%
                            ...
                            List<Categoria> categorias = categoria.consultar(idUser, "R");
                        %>
                        <div>
                            <form action="recebeDadosReceita.jsp" method="POST">
                                ...
                                <input style="width: 30%; padding: 4px" type="text" name="valor" onkeyup="formatarMoeda() / >
                                            <br />
    ...
    function formatarMoeda() {
                var elemento = document.getElementsByName('valor')[0];
