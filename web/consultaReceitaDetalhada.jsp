<%-- 
    ...
    Created on : 28/01/2021, 08:34:44
    Author     : entra21
--%>
    ...
    <body>
        ...
        <div class="container4"><h1>Consulta Receita Detalhada</h1>
            ...
            <form action="consultaReceitaDetalhada.jsp" method="POST">
                ...
                <label>Agrupar?</label>
                <input  style="width: 50%" type="checkbox" name="agrupar" checked="true" />
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><% out.write(String.valueOf(ConversorData.formataMoeda(r.getValor())));%></td>
